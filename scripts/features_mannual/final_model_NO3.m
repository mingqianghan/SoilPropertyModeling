...
clear
close all
VWC_feature_file= "C:\Users\mingqiang\OneDrive - Kansas State University\K-state Research\Soil sensor\Models\SoilAnalysis\scripts\features_mannual\VIP_frequencies_NO3_Combined_new.xlsx";
...
output_folderPath = fullfile('VIP_results_new', 'NO3_R2_R3_nonoutliers(allcombined100)_cat_70_15_15_new');
...
for i = 1:length(Predictors)
    ...
    [data_x_exp_Urea, data_y_exp_Urea, label_Urea] = extract_and_clean_data(lab_data_N_exp_Urea, 'lab', p, 'NO3');
    [data_x_exp_NH4NO3, data_y_exp_NH4NO3, label_NH4NO3] = extract_and_clean_data(lab_data_N_exp_NH4NO3, 'lab', p, 'NO3');
    ...
    [data_x_field, data_y_field, label] = extract_and_clean_data(field_data(matches), 'field', p, 'NO3');
    ...
    % train_x = [data_x_exp_Urea; data_x_exp_NH4NO3; train_x_field];
    % train_y = [data_y_exp_Urea; data_y_exp_NH4NO3; train_y_field];
    % train_label = [label_Urea; label_NH4NO3; train_label_field];
    ...
    model_folderPath = fullfile('VIP_results_new', 'NO3_R2_R3_nonoutliers(allcombined100)_cat_70_15_15_new', p);
