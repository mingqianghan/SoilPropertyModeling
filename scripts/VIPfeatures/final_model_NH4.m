...
clear
close all
VWC_feature_file= "C:\Users\mingqiang\OneDrive - Kansas State University\K-state Research\Soil sensor\Models\SoilAnalysis\scripts\VIPfeatures\VIP_frequencies_NH4_Combined.xlsx";
...
output_folderPath = fullfile('VIP_results', 'NH4_nonoutliers(new)_50_25');
...
for i = 1:length(Predictors)
    ...
    [train_x_field, train_y_field, train_label_field, val_x, val_y, val_label, test_x, test_y, test_label] = split_data(data_x_field, data_y_field, split_ratio1, split_ratio2, label, true);

    train_x = [data_x_exp_NH4NO3; train_x_field];
    train_y = [data_y_exp_NH4NO3; train_y_field];
    train_label = [label_NH4NO3; train_label_field];
    ...
    % 
    % model_folderPath = fullfile('VIP_results', 'NH4_R2_R3_nonoutliers_50_25', p);
