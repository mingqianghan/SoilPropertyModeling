...
clear
close all
VWC_feature_file= "C:\Users\mingqiang\OneDrive - Kansas State University\K-state Research\Soil sensor\Models\SoilAnalysis\scripts\VIPfeatures\VIP_frequencies_NO3_Combined.xlsx";
...
output_folderPath = fullfile('VIP_results', 'NO3_R2_R3_nonoutliers(allcombined100)_cat_70_15_15');
...
for i = 1:length(Predictors)
    ...
    model_folderPath = fullfile('VIP_results', 'NO3_R2_R3_nonoutliers(allcombined100)_cat_70_15_15', p);
