...
folders = { ...
  "results_final\Lab_wc_inter_repeat",         {'R1','R2','R3'},         true; 
  "results_final\Lab_wc_across_calibration",   {'R1','R2','R3'},         true; 
  "results_final\Field_inter_sensor\VWC_80",   {'EP_ON','EP_WN','LP_WN','LP_ON'}, false;
  "results_final\Field_accross_sensor\VWC_80", {'__'},                    false
};
